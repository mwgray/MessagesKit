...
@protocol SQLRelation <NSObject>

@property (nonatomic, readonly) NSString *alias;
@property (nonatomic, readonly) NSString *name;
@property (nonatomic, readonly) SQLTable *table;

@end

@interface SQLTable : NSObject <SQLRelation>
...
@interface SQLJoin : NSObject <SQLRelation>

@property (nonatomic, readonly) NSString *alias;
@property (nonatomic, strong) SQLTable *leftTable;
@property (nonatomic, strong) NSString *leftColumn;
@property (nonatomic, strong) SQLTable *rightTable;
...
-(instancetype) initWithRootClass:(NSString *)rootClassName tableNames:(NSDictionary *)tableNames;
{
  ...
  if ((self = [super init])) {
    ...
    [_relations addObject:[[SQLTable alloc] initWithName:tableNames[rootClassName]
...
-(NSString *) expressionForKeyPath:(NSString *)keyPath
{
  ...
  if (keyPathParts.count == 1) {
    ...
    id<SQLRelation> relation = [_relationStack lastObject];
...
-(NSString *) declaredExpressionForKeyPath:(NSString *)keyPath
{
  ...
  for (id<SQLRelation> relation in _relations) {
